...
if (!empty($_POST['mail'])) {
    $fields .= '<tr>
                <td style="text-align: right;width: 30%; padding-top: 5px;padding-bottom: 5px;">
                    <span style="font-size: 14px; color: #999999;padding-right: 20px; display:block;">E-mail:</span>
                </td>
                <td style="text-align:left;width: 70% ; padding-top: 5px;padding-bottom: 5px; vertical-align: top;">
                    <span style="font-size: 18px; color: #000000">' . $_POST['mail'] . '</span>
                </td>
            </tr>';
}
if (!empty($_POST['date'])) {
    $fields .= '<tr>
                <td style="text-align: right;width: 30%; padding-top: 5px;padding-bottom: 5px;">
                    <span style="font-size: 14px; color: #999999;padding-right: 20px; display:block;">Дата/время:</span>
                </td>
                <td style="text-align:left;width: 70% ; padding-top: 5px;padding-bottom: 5px; vertical-align: top;">
                    <span style="font-size: 18px; color: #000000">' . $_POST['date'] . '</span>
                </td>
            </tr>';
}
if (!empty($_POST['message'])) {
    $fields .= '<tr>
                <td style="text-align: right;width: 30%; padding-top: 5px;padding-bottom: 5px;">
                    <span style="font-size: 14px; color: #999999;padding-right: 20px; display:block;">Сообщение:</span>
                </td>
                <td style="text-align:left;width: 70% ; padding-top: 5px;padding-bottom: 5px; vertical-align: top;">
                    <span style="font-size: 18px; color: #000000">' . $_POST['message'] . '</span>
                </td>
            </tr>';
}
if (!empty($_POST['trigger'])) {
    $fields .= '<tr>
                <td style="text-align: right;width: 30%; padding-top: 5px;padding-bottom: 5px;">
                    <span style="font-size: 14px; color: #999999;padding-right: 20px; display:block;">Кнопка:</span>
                </td>
                <td style="text-align:left;width: 70% ; padding-top: 5px;padding-bottom: 5px; vertical-align: top;">
                    <span style="font-size: 18px; color: #000000">' . $_POST['trigger'] . '</span>
                </td>
            </tr>';
}
...
$mail->addAddress('resursintech@gmail.com');
